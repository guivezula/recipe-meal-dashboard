...
/**
 * This slice was generated by IA but it needed to be modified 
 * As I mentioned before Map cannot be serialized so I did some changes 
 * to fit the code to work
 * @param {any} {name:"shoppingList"
 * @param {any} initialState
 * @param {any} reducers:{generateShoppingListByMeals:(state
